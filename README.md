...
Работают регистрация владельца, доступ по одноразовым приглашениям, главное меню, раздел семьи, рецепты, меню недели и список покупок.
...
- В разделе «🛒 Покупки» можно собрать список из меню, добавить свои позиции и отмечать статусы.
