...
Для списка покупок использовать `app/services/shopping.py`: там сборка из меню, пересборка с сохранением статусов, форматирование количеств и распознавание текстовых команд.
